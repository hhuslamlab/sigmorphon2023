...
Usage:
    evaluate --lang=<l> --prediction-filepath=<pp> --gold-filepath=<gp>
...
if __name__ == "__main__":
    ...
    with open('processed_predictions_orig/'+ lang + '_' + ".txt", 'w+') as f:
    ...
    with open('processed_predictions_orig/wrong_preds_' + lang + ".txt", 'w+') as f:
    ...
    with open("accuracies_orig/" + lang + ".txt", "w+") as f:
